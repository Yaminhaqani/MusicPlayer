...
const ProfilePic = () => {
  ...
  return (
    <div className='flex flex-col gap-3 w-full h-[88.1vh] justify-center items-center bg-gray-950 border-t-2 border-gray-800 font-roboto pb-[4rem] text-gray-200'>
